...
/**
 * Retrive an array of the assets which are used in a page in asset chunks, slideshows, and inline in text chunks.
 *
 */
class Boom_Page_AssetsUsed
{
	...
	public function get_all()
	{
		return ORM::factory('Asset')
			...
			->or_where('chunk_texts.page_vid', '=', $this->_page->version()->id)
			...
			->or_where('chunk_slideshows.page_vid', '=', $this->_page->version()->id)
