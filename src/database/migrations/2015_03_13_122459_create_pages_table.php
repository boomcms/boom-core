...
class CreatePagesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('pages', function (Blueprint $table) {
            ...
            $table->string('children_url_prefix', 2048)->charset('utf8')->nullable();
            ...
            $table->string('primary_uri', 2048)->nullable();
        ...
        DB::statement('ALTER TABLE pages ADD FULLTEXT pages_primary_uri(primary_uri)');
    }
