<form>
    <h1><?= Lang::get('boomcms::settings.search.heading') ?></h1>
	...
	<div id="b-pagesettings-search">
		<section id="basic">
            ...
            <label>
                <p><?= Lang::get('boomcms::settings.search.description') ?></p>
                <textarea name="description" rows="5"><?= $page->getDescription() ?></textarea>
            </label>

            <label>
                <p><?= Lang::get('boomcms::settings.search.keywords') ?></p>
		...
		<?php if ($allowAdvanced): ?>
			<section id="advanced">
                ...
                <label>
                    <p><?= Lang::get('boomcms::settings.search.external') ?></p>
                ...
                <label>
                    <p><?= Lang::get('boomcms::settings.search.internal') ?></p>
