<form class="b-form-settings">
        ...
        <label>
            ...
            <input type="text" name="embargoed_until" value="<?= ($version->embargoed_until) ? date("d F Y h:i", $version->embargoed_until) : date("d F Y h:i", time()) ?>" class="boom-datepicker" id="page-embargo" />
        </label>
</form>
