...
<p style="text-align:left;">The system administrator created an account for you on the <a href="<?= url('/') ?>" style="color:#404040; text-decoration:underline !important;font-weight:bold;"><?= $siteName ?></a> website.<br />Here are your login details:</p>
