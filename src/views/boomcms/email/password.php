...
<p style="text-align:left;">To create a new CMS password please follow the link below<br /><br /><a href="<?= URL::route('password'), "/$token" ?>" style="color:#404040; text-decoration:underline !important;font-weight:bold;"><?= URL::route('password'), "/$token" ?></a>.</p>
