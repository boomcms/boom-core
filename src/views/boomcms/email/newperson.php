...
<p style="text-align:left;">Please go to <a href="<?= URL::route('login') ?>" style="color:#404040; text-decoration:underline !important;font-weight:bold;"><?= URL::route('login') ?></a> to login.</p>
