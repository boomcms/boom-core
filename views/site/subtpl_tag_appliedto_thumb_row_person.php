...
<?$ki = Kohana::Instance();?>
	...
	<?}?>
	<span style="display:block;height:100px;width:100px;background:url(/cms_user_manager/get_user/<?=$ki->recursing['tag_contents']->rid?>/100/100) no-repeat center center">&nbsp;</span>       
	<?if (!$ki->recursing["rubbishrow"]) {?>
		</a>
	<?}?>
	<?
