				...
				<div class="item<?if (($i+1) %3 == 0): ?> last<? endif; ?>">
					<dl>
						...
						<dd class="description">
							<p><?= $asset->title ?> <a onclick="_gaq.push(['_trackEvent', 'Downloads', '<?= $asset->get_type() ?>', '<?=$asset->title?>']);" href="/asset/view/<?=$asset->id?>"><?=$asset->get_type()?> <?= Num::filesize( $asset->filesize ) ?></a></p>
							<p class="download">
