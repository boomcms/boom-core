...
<?$ki = Kohana::Instance();?>
				...
				<div class="col3 title">
					...
					<a title="<?=$ki->recursing["tag_contents"]->firstname.' '.$ki->recursing["tag_contents"]->lastname;?>" rel="ajax" id="<?=$ki->type?>_<?=$ki->recursing["tag_contents"]->rid?>" href="#<?=$ki->type?>/<?=$ki->recursing["tag_contents"]->rid?>" class="person">
						<?=$ki->recursing["tag_contents"]->firstname.' '.$ki->recursing["tag_contents"]->lastname;?>
					</a>
