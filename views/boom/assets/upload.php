			...
			<div class="ui-widget" id="boom-asset-upload-info">
				<div class="ui-corner-all">
					<p>
						...
						<span class="message">Drag and drop files here, or use the + button, to start uploading.  <?=__('Allowed file types')?>: <?= implode(', ', Boom_Asset::$allowed_extensions) ?></span>
					</p>
				</div>
			</div>
			<div id="b-upload-progress"></div>
				<input type="file" name="b-assets-upload-files[]" id="b-assets-upload-file" multiple min="1" max="5" />
				<button id="b-assets-upload" class="boom-button ui-button-text-icon" data-icon="ui-icon-boom-add">
					<?=__('Add files')?>
				</button>
