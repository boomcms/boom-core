	...
	<body>
		...
		<div id="help">
			<div class="column">
				...
				<?if (Kohana::config('issuetracker.enable')) {?>
					<form method="post" action="#" style="width: 450px; margin-right: auto; margin-left: auto;" id="report-problem-form">
						...
						<table>
							...
							<tr><td>&nbsp;</td></tr>
							<tr><td><?=form::submit('report_problem_submit','Send problem report')?></td></tr>
						</table>
					</form>
				...
				<p>You can <?if (Kohana::config('issuetracker.enable')){?>also <?}?>contact us through <a href="http://hoop.basecamphq.com">HoopBase</a> 
