...
* Rob wanted to add a link next to the user guide / api browser links back to the main CMS.  
* "Not a problem", he though, "with Kohana's cascading file system I can just overload the relevant template" 
* But alas, the whole thing is one big template. So This a copy and past from Kohana's userguide module with the minor addition of one extra link.  
* Should the template for the userguide be change, this will need to updated.
*
* 2012/03/29
*/
?>
