<div id="sledge-topbar" class="ui-helper-clearfix ui-tabs ui-widget ui-widget-content ui-corner-all"> 
	...
	<div class="ui-helper-clearfix ui-tabs-panel ui-widget-content ui-corner-bottom">
		<div id="sledge-page-actions" class="ui-helper-right">
			<button id="sledge-tagmanager-upload" class="sledge-button ui-button-text-icon" onclick="window.frames[0].location='/cms/assets/upload'">
				<span class="ui-button-icon-primary ui-icon ui-icon-disk"></span>
				Upload files
			</button>
			<button id="sledge-tagmanager-save-all" class="sledge-button ui-button-text-icon">
				<span class="ui-button-icon-primary ui-icon ui-icon-disk"></span>
				Save all
			</button>
		</div>
